            ...
            <div class="main__breadcrumb">
                <div class="container">
                    <div class="bread-crumb">
                        <span><a href="${resource }/index">Trang chủ</a></span>
                        <span><a href="./danhmuc.html">Danh mục sản phẩm</a></span>
                        <span><a href="./sanpham.html">Sản phẩm</a></span>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-12">
                            ...
                            <form class="form-inline" action="${resource }/product-detail" method="POST">
	                                                ...
	                                                <div class="swiper-wrapper">
	                                                	...
	                                                	<c:forEach items="${productImages }" var="productImage">
		                                                    <div class="swiper-slide">
		                                                        <img src="${resource }/UploadFiles/${productImage.path }" alt=""
