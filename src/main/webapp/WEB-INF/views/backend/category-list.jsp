                                ...
                                <div class="table-responsive">
                               	...
                               	<div class="row">
										...
										<div class="form-group mb-4">
	                                        <a href="${resource }/admin/category/add" role="button" class="btn btn-primary">Add New Category</a>
                                      	</div>
                                   	</div>
                                        ...
                                        <tbody>
                                        	<c:forEach var="category" items="${categories }" varStatus="loop">
                                        		<tr>
	                                        		...
	                                        		<td>
	                                        			<a href="${resource }/admin/category/edit/${category.id }" role="button" 
	                                                							class="btn btn-primary">Edit</a>
	                                                	<a href="${resource }/admin/category/delete/${category.id }" role="button" 
