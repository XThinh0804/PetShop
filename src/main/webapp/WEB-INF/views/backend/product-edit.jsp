...
<link rel="icon" type="image/png" sizes="16x16"
	href="${resource }/backend/assets/images/favicon.png">
<title>${title }</title>
<!-- variables -->
			...
			<div class="container-fluid">
                ...
                <div class="row">
                	<div class="col-12">
	                    <div class="card">
	                        <div class="card-body">
	                        	<sf:form class="form" action="${resource }/admin/product/edit-save" method="post" modelAttribute="product" enctype="multipart/form-data">
	                        		 ...
	                        		 <div class="form-body">
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        <a href="${resource }/admin/product/list" class="btn btn-secondary active" role="button" aria-pressed="true">
			                                        	Back to list
			                                        </a>
